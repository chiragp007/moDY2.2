...
// void compute_position(Particle* particles, size_t n, double dt,size_t grid_size_x, size_t grid_size_y, size_t grid_size_z,extended_list* list_cells, extended_list* list_particles){
...
void compute_position(Particle* particles, size_t n, double dt, int  grid_size_x, int grid_size_y, size_t grid_size_z, extended_list* list_cells, extended_list* list_particles,double spacing) {
    ...
    for (size_t i = 0; i < n; i++) { // For every particle
        ...
        if (cell_index != particles[i].init_cell_index ){
            ...
            list_cells[cell_index].integer = list_particles[cell_index].ID;
...
void compute_acceleration(Particle* particles, size_t n, double dt){
...
int main(int argc, char* argv[]){
    ...
    size_t grid_size_x = 5;
    size_t grid_size_y = 5;
    size_t grid_size_z = 5;

   double spacing = 5.0; // Adjust the spacing as needed, works as a cell size .. we can increase this
